...
## Initialize the managed runtime first [#initialize-the-managed-runtime-first]

Start from the user-level managed runtime:
...
- If the runtime is not initialized, run `ahtml init`.

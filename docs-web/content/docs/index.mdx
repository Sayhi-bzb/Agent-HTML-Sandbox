...
`@alpha` currently resolves to `0.1.0-alpha.0`. `ahtml init` delegates Vite + shadcn setup to your local project, then writes the ahtml integration config and renderer adapter files.

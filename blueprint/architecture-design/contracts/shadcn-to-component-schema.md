...
contract maintenance / renderer integration layer 消费 shadcn registry、组件源码、`components.json`、runtime verification facts 和显式语义声明，并产出 standardized component schema、presentation profile compatibility 和通用 renderer registry 输入。

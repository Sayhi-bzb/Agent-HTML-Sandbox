...
export async function getCliSchemaOutput(root = packageRoot) {
  ...
  const renderConfigDefaults =
    renderConfigModule.PUBLIC_RENDER_CONFIG_DEFAULTS ??
    renderConfigModule.DEFAULT_RENDER_CONFIG
...
function assertRenderConfigModule(module) {
  ...
  if (!module.PUBLIC_RENDER_CONFIG_DEFAULTS && !module.DEFAULT_RENDER_CONFIG) {
    throw new Error("Cannot load public render config defaults.")
  }

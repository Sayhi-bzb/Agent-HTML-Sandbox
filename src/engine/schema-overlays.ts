...
export const COMPONENT_SCHEMA_OVERLAYS = [
  ...
  },
  {
    ...
    expose: true,
    sourceComponents: ["ToggleGroup", "Checkbox"],
    props: [
      {
        name: "title",
        valueKind: "string",
    ...
    hiddenProps: ["type", "value", "defaultValue"],
  },
  {
    name: "choice",
    description: "Choice option.",
    expose: true,
    sourceComponents: ["ToggleGroupItem", "Checkbox"],
    props: [
      {
        name: "value",
        valueKind: "string",
  ...
  },
  {
    ...
    allowedChildren: [TEXT_CHILD],
    hiddenProps: ["value", "defaultValue", "onValueChange"],
  },
  {
    name: "feedback-box",
    description: "Editable feedback capture with copy action.",
    expose: true,
    sourceComponents: ["Textarea", "Button"],
    props: [
      {
        name: "title",
        valueKind: "string",
    ...
    allowedChildren: [TEXT_CHILD],
    hiddenProps: ["value", "onChange", "onClick"],
  },
  {
    name: "progress-meter",
